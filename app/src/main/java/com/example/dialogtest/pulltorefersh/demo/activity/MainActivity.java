package com.example.dialogtest.pulltorefersh.demo.activity;
...
import com.example.dialogtest.pulltorefersh.demo.fragment.GridFragment;
import com.example.dialogtest.pulltorefersh.demo.fragment.LinearFragment;
import com.example.dialogtest.pulltorefersh.demo.fragment.StaggeredGridFragment;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pull_to_refersh_demo);
