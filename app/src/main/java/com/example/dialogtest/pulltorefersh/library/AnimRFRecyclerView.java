package com.example.dialogtest.pulltorefersh.library;
...
import com.example.dialogtest.pulltorefersh.library.decoration.DividerGridItemDecoration;
import com.example.dialogtest.pulltorefersh.library.decoration.DividerItemDecoration;
import com.example.dialogtest.pulltorefersh.library.listener.OverScrollListener;
import com.example.dialogtest.pulltorefersh.library.manager.AnimRFGridLayoutManager;
import com.example.dialogtest.pulltorefersh.library.manager.AnimRFLinearLayoutManager;
import com.example.dialogtest.pulltorefersh.library.manager.AnimRFStaggeredGridLayoutManager;
    ...
    private void headerImageHint() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                headerImage.getLayoutParams().height = (Integer) animation.getAnimatedValue();
                updateHeaderAlpha();
